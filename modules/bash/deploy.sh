...
MODULE_DIR="${DOTFILES_ROOT}/modules/bash"
...
case "${1:-}" in
  -h|--help|help)
    ...
    ;;
  describe)
    describe_link "${MODULE_DIR}/files/.bashrc" ".bashrc"
    ;;
  deploy)
    link_item "${MODULE_DIR}/files/.bashrc" ".bashrc"
    ;;
  verify)
    verify_link "${MODULE_DIR}/files/.bashrc" ".bashrc"
    ;;
  *)
